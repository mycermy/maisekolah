  ...
  <div class="p-4 sm:p-7">
    <div class="text-center">
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
        ...
        <a class="text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="/account/register">
          Sign up here
        </a>
      </p>
    </div>
      ...
      <form method="POST" action="/auth/login">
        <div class="grid gap-y-4">
          ...
          <div>
            ...
            <div class="relative">
              <input class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                type="email"
                id="email"
                name="email"
                value="<?= old('email') ?>"
          ...
          <div>
            <div class="flex flex-wrap justify-between items-center gap-2">
              ...
              <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500"
                href="/account/recover">Forgot password?</a>
            </div>
            <div class="relative">
